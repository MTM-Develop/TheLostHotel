...
public class Description {
    ...
    public static final String DESCRIPTION_ROOM_79 = "Ore 2:32. Non riesci a prendere sonno.\n" +
            "Continui a pensare a ciò che vi è successo poco fa.\n" +
            "\"Dove sono Ethan e John?\", ti chiedi.\n" +
            "Forse sarebbe meglio andarli a cercare e non restare con le mani in mano...";

    public static final String DESCRIPTION_BATHROOM_79 = "Un bagno, tutte le stanze d'hotel che si \n" +
    ...
    public static final String DESCRIPTION_FURNITURE_79 = "Un classico mobile presente nella tua stanza, sembra contenere qualcosa " +
            "al suo interno.";

    public static final String DESCRIPTION_WARDROBE_79 = "Un armadio imponente che occupa mezza stanza!\n" +
            "Sembra essere bloccato da qualcosa <<oggetto>> "; //agg ogg

    public static final String DESCRIPTION_PAINT_79 = "Un quadro cupo e polveroso, sembra essere antico...";

    public static final String DESCRIPTION_FURNITURE_BATHROOM_79 = "Un cestino da bagno. Sei abbastanza curioso di " +
            "sapere cosa ci sia al suo interno?";

    public static final String DESCRIPTION_BED_79 = "Un letto a due piazze. È stato un po' scomodo...";
