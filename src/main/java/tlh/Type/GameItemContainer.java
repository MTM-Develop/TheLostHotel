...
public class GameItemContainer extends GameItem implements Serializable {
    ...
    private boolean iCNotOpenable= false; //indica se è utile o meno riferendosi al comando "Apri" (Es. se non ci fosse, al comando "Apri tv" verrebbe visualizzato il messaggio: "L'oggetto è stato aperto, ma è vuoto!"
    ...
    public void setiCNotOpenable(boolean iCNotOpenable) {
        this.iCNotOpenable = iCNotOpenable;
    }
